...
sudo pacman --needed -S rawtherapee gimp obsidian gvfs gphoto2 xdg-desktop-portal syncthing spectacle raw-thumbnailer kdesdk-thumbnailers kdegraphics-thumbnailers i3lock gwenview
